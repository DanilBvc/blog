...
import { getDateFrom, getDateHoursMinute } from '../../../utils/getDate';
import './studioItem.scss';

const StudioItem: FC<studioItemProps> = ({ video, checkBoxEvent, checkBoxes }) => {
  const { like, dislike, _id, updatedAt, viewsCount, comments, createdAt } = video;
  ...
  return (
    <div className="studio-item-wrapper">
      <CheckBox
        ...
        label={''}
      />
      <div className="studio-item-preview"></div>
